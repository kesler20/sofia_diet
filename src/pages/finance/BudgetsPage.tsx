...
function CategoryContainer(props: {
  ...
  return props.categoryType === "income" ? (
    <div className="flex flex-col w-full bg-green-100 rounded-2xl p-4 overflow-y-scroll scrollbar-hide h-[60vh]">
      {props.children}
    </div>
  ) : (
    <div className="flex flex-col w-full bg-red-100 rounded-2xl p-4 overflow-y-scroll scrollbar-hide h-[60vh]">
      {props.children}
    </div>
  );
}
...
export default function BudgetsPage() {
  ...
  return (
    <div className="md:px-24 h-[88vh] bg-gray-50 relative overflow-hidden">
      {/* Popup menu */}
